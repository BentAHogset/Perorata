...
namespace triton.Controls
{
    public partial class AdvancedEntry : StackLayout
    {
        ...
        #region Fields
        readonly Label lblTitle = new Label { Margin = new Thickness(6, 0, 0, 0), IsVisible = false, LineBreakMode = LineBreakMode.TailTruncation};
        readonly Label lblAnnotation = new Label { Margin = new Thickness(6, 0, 0, 0), IsVisible = false, FontSize = Device.GetNamedSize(NamedSize.Micro, typeof(Label)), Opacity = 0.8 };
